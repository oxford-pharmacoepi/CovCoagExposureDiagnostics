...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "diagCovCoagExposures",
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "diagCovCoagExposures")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "diagCovCoagExposures")
